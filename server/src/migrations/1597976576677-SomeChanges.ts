...
export class SomeChanges1597976576677 implements MigrationInterface {
    name = 'SomeChanges1597976576677'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `project` CHANGE `videoUrl` `videoUrl` varchar(255) NOT NULL");
        await queryRunner.query("ALTER TABLE `project` CHANGE `sourceControlUrl` `sourceControlUrl` varchar(255) NOT NULL");
        await queryRunner.query("ALTER TABLE `project` CHANGE `url` `url` varchar(255) NOT NULL");
        await queryRunner.query("ALTER TABLE `project` ADD CONSTRAINT `FK_62aa5845962762e0cefe729dfd7` FOREIGN KEY (`thumbnailId`) REFERENCES `user_file`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
