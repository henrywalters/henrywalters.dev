...
export class ChangeImageTOUserFile1597890847028 implements MigrationInterface {
    name = 'ChangeImageTOUserFile1597890847028'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `project` DROP FOREIGN KEY `FK_62aa5845962762e0cefe729dfd7`");
        await queryRunner.query("CREATE TABLE `user_file` (`id` varchar(36) NOT NULL, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `deletedAt` datetime(6) NULL, `name` varchar(255) NOT NULL, `alt` varchar(255) NOT NULL, `cdn` varchar(255) NOT NULL, `cdnId` varchar(255) NOT NULL, `userId` varchar(36) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
