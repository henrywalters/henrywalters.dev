...
export class AddedSourceToTracking1601002459209 implements MigrationInterface {
    name = 'AddedSourceToTracking1601002459209'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `page_visit` ADD `source` varchar(255) NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `page_visit` DROP COLUMN `source`");
    }
